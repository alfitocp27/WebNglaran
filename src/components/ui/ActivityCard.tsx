...
export default function ActivityCard({ title, description, image, className = '' }: ActivityCardProps) {
  return (
    <article
      className={`stagger-card group border border-zinc-100 rounded-3xl overflow-hidden bg-bg-base hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-500 flex flex-col ${className}`}
    >
